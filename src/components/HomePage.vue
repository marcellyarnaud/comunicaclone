                                    ...
                                    <div class="app flex-row">
                                        <div class="container py-4">
                                            <div class="text-right mb-5">
                                                <img class="logoSerpro" src="images/logo-serpro-2021.jpg">
                                            </div>
                                            <div class="mx-5">
                                                <div class="mt-3 mb-4">
                                                    <img src="images/solucoes-corporativas.png"
                                                ...
                                                <form id="frmLogin">
                                                    ...
                                                    <div id="frmLogin-password-group" class="form-group"
                                                        ...
                                                        <label for="frmLogin-password" class="control-label"><em>*</em>
                                                            Senha</label>
                                                        <div class="input-group">
                                                            <input id="frmLogin-password" name="Senha"
                                                                class="form-control" type="password"
                                                                data-input-type="senha">
                                                            <button class="btn btn-secondary px-2" id="button-addon2"
                                                                title="mostrar/ocultar senha" type="button">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="custom-control custom-checkbox">
                                                            ...
                                                            <a href="auth/esqueci-minha-senha">Esqueceu sua senha</a>
                                                        </div>
                                                    </div>
                                                    <p class="mb-5">
