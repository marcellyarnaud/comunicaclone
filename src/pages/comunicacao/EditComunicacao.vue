...
<div class="modal-content">
    ...
    <form id="frmModalCadastro">
    <div class="modal-body">
        <input id="acao" type="hidden" value="ESCRITA">
        <div class="separador-base">
            <div class="row">
                <div id="titulo" class="dynamic-field col-sm-8" data-input-type="text" aria-label="Título" aria-required="true" data-rows="64"></div>
                <div id="adicionarReacao" class="dynamic-field col-sm-4 pt-4" data-input-type="check" aria-label="Adicionar campos de reação"></div>
            </div>
            <div id="resumo" class="dynamic-field" data-input-type="memo" aria-label="Resumo" aria-required="true" data-max-length="512"></div>   
